...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 0.0001**(self.trials)
            #self.epsilon = 1/numpy.square(self.trials)
    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            if state not in self.Q:
                self.Q[state] = {'left': 0.0, 'forward': 0.0, 'right': 0.0, None: 0.0}
    ...
    def choose_action(self, state):
        ...
        if self.learning == True:
            ...
            if r < self.epsilon*100:
                ...
                best_actions = [action for action in self.valid_actions if self.Q[state][action] == maxqvalue]
            #act = []
...
def run():
    ...
    sim.run(tolerance=0.0000001, n_test=25)
